...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 shiny-button",
  {
    variants: {
      variant: {
        ...
        shimmer: "animate-shimmer text-primary-foreground hover:scale-[1.02] active:scale-[0.98]",
      },
      size: {
