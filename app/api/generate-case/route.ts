...
export async function POST(req: Request) {
  try {
    ...
    // First, generate patient demographics with AI using a direct approach
    ...
    // Now generate the full case study with the AI-generated demographics
...
1. Chief complaint & detailed history (include duration, severity, associated symptoms)
...
3. Assessment/diagnosis with detailed explanation
...
Format all tables cleanly with proper headers and aligned data. Use medical terminology but include explanations where needed.
DO NOT include patient demographics in the case study content as they will be displayed separately.
